 ...
 * @author kyo
 */
public class TextToSpeechCOM2 implements IKKVSpeek {

  ActiveXComponent  speak = null;

  public TextToSpeechCOM2() {    
    if (speak == null) {
      try {
  ...
  public void say(String text) {
    ...
    try {
      ...
      speak.invoke("Speak", new Variant[]{new Variant(text),new Variant(3)});
    } catch (Exception e) {
      e.printStackTrace();
    }
  }
  ...
  public static void main(String[] args) {
    TextToSpeechCOM2 tts = new TextToSpeechCOM2();
    tts.say("тест");
    pause();
    tts.say("Hello тест");
    pause();
