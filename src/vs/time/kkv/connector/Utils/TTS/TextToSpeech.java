...
import vs.time.kkv.connector.Utils.AudioPlayer;
 ...
 *
 */
public class TextToSpeech implements IKKVSpeek{
	

  public AudioPlayer tts;
	 ...
	 */
	public synchronized void speak(String text , float gainValue , boolean daemon , boolean join) {
	 ...
	 * @param voice
	 */
	public TextToSpeech setVoice(String voice) {
